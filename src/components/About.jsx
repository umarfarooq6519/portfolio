            ...
            <div className="grid grid-cols-12">
              ...
              <div className="col-span-4 flex items-center pb-80">
                <p className="text-base">
                  ...
                  when diving into the intricacies of a brand's story, ensuring
                  that every element of the website reflects and communicate the
          ...
          <div className="mx-32 grid grid-cols-12 gap-28 border-b border-gray-300 pb-[16em] pt-[26em]">
            <div className="col-span-8 flex h-full">
              <h5>
                ...
                Pakistan with over three years of experience in crafting
